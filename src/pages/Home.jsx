        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-yellow-400 hover:bg-yellow-500 disabled:bg-gray-500 text-black font-bold py-4 rounded-2xl text-xl transition duration-500"
            >
  ...
  🔐 Team Login
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-gray-400">
              ...
              <a href="#prayer-request" className="hover:text-yellow-400 transition">
                Prayer Request
              </a>
